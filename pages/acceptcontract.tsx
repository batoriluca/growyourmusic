...
import style from '../styles/acceptcontract.module.css'
                ...
                <div className={style.dm}>
                  ...
                  <div className={style.chat}>
                    ...
                    <Link href="/productdetails">
                      <h3 className={style.prod_titlefr}>"Voi face un beat pentru tine"</h3>
                    </Link>
                    <div
                    ...
                    >
                      <h3>Preț:</h3>
                      <h3 className={style.pret}>1250 RON</h3>
                    </div>
                    <h3>Perioada în care trebuie să livrezi serviciul/produsul:</h3>
                    <h3 className={style.perioada}>O lună (16.08.2022)</h3>
                    <button id="accept">Acceptă oferta</button>
                    <button id="refuz" className={style.refuz}>
                      Refuză oferta
                    </button>
                    <div className={style.acc}>
                      <h3>Ești sigur că vrei să accepți acest contract?</h3>
                      <Link href="/sendprod">
                        <button>Da</button>
                      </Link>
                      <button id="accn">Nu</button>
                    </div>
                    <div className={style.ref}>
                      <h3>Ești sigur că vrei să refuzi acest contract?</h3>
                      <button>Da</button>
                      <button id="refn">Nu</button>
                    </div>
                  </div>
                </div>
              </div>
