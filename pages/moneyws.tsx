...
import style from '../styles/moneyws.module.css'
              ...
              <div className={style.feed_posts}>
                <div className={style.dm}>
                  ...
                  <div className={style.chat} style={{ textAlign: "center" }}>
                    <h3>
                      <span className={style.alb}>Felicitări,</span> banii pentru acest produs îți vor ajunge în <span className={style.mov}> portofelul tău
                        GrowYourMusic</span> în aproximativ 24 de ore, dacă nu va fi raportată nicio
                      problemă.
                    </h3>
                  </div>
                </div>
