...
leftA.addEventListener("click", () => {
    ...
    if (move !== 1) {
        ...
        rightApx += px;
        leftApx -= px;
        document.querySelector(".newproduct_img_part__q4_yt").setAttribute("style", "transform:translateX(-" + (move - 1) * px + "px);")
...
rightA.addEventListener("click", () => {
    ...
    if (move !== 3) {
        ...
        document.querySelector(".img_part").setAttribute("style", "transform:translateX(-" + (move - 1) * px + "px);")
        document.querySelector("#arrowRight").setAttribute("style", "right: " + rightApx + "px;")
        document.querySelector("#arrowLeft").setAttribute("style", "left: " + leftApx + "px;")
    }
})
